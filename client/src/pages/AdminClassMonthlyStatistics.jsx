...
function AdminClassMonthlyStatistics() {
  ...
  const handleViewStatistics = (classId) => {
    // 월별 통계 보기 페이지로 이동
    navigate(`/admin/class/${classId}/monthly-statistics`);
  };
        ...
        <div className="admin-content">
          <div className="page-header">
            ...
            <div className="page-header-content">
              <h1 className="admin-title">수업현황 조회</h1>
              <p className="admin-description">
                각 반마다 월별로 전체 학생들의 데이터를 확인할 수 있습니다.
              </p>
            </div>
          </div>
...
export default AdminClassMonthlyStatistics;
