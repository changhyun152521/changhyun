...
function ParentMonthlyStatistics() {
  ...
  const handleViewStatistics = (classId) => {
    ...
    // 월별 통계 보기 페이지로 이동 (학생 ID 포함)
    navigate(`/parent-class/${classId}/monthly-statistics?studentId=${selectedStudent._id}`);
  };
        ...
        <div className="container">
          ...
          {!selectedStudent ? (
            <div className="no-classes-container">
              ...
              <h2>자녀를 선택해주세요</h2>
              <p>위에서 자녀를 선택하면 월별 통계를 확인할 수 있습니다.</p>
            </div>
          ) : classes.length === 0 ? (
            <div className="no-classes-container">
              <div className="no-classes-icon">
...
export default ParentMonthlyStatistics;
